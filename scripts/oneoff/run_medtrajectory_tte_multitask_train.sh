...
CONFIG_PATH="semantic_delphi_ukb/config_medtrajectory_exp2_tte_multitask.py"
SESSION_NAME="${1:-medtrajectory_exp2_tte_multitask}"
...
CMD="PYTHONUNBUFFERED=1 $PYTHON_BIN train_tte_multitask.py $CONFIG_PATH --device='$DEVICE'"
