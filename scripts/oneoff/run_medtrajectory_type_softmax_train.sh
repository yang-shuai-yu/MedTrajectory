...
CONFIG_PATH="semantic_delphi_ukb/config_medtrajectory_exp2_type_softmax.py"
SESSION_NAME="${1:-medtrajectory_exp2_type_softmax}"
...
CMD="PYTHONUNBUFFERED=1 $PYTHON_BIN train_type_softmax_multitype.py $CONFIG_PATH --device='$DEVICE'"
