...
out_dir = "ckpt/MedTrajectory_exp2_modern_block48"
eval_interval = 250
eval_iters = 25
log_interval = 25
seed = 42
...
wandb_run_name = "medtrajectory_exp2_modern_block48_" + str(time.time())
...
model_family = "medtrajectory_modern_block48"
