...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate a MedTrajectory modern multitype checkpoint.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    payload = {
        ...
        "model_family": checkpoint_config.get("model_family", "medtrajectory_modern"),
